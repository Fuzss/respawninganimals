...
public class ModRegistry {
    ...
    public static final GameRules.Key<GameRules.IntegerValue> ANIMAL_MOB_CAP_GAME_RULE = GameRulesFactory.INSTANCE.register(
            "animalMobCap",
            GameRules.Category.SPAWNING,
            GameRulesFactory.INSTANCE.createIntRule(15, 0, 100, (server, booleanValue) -> {
                AnimalSpawningHandler.setCreatureAttributes(server.getGameRules());
            }));
    public static final GameRules.Key<GameRules.BooleanValue> PERSISTENT_ANIMALS_GAME_RULE = GameRulesFactory.INSTANCE.register(
            "persistentAnimals",
            GameRules.Category.SPAWNING,
