...
public class ServerConfig implements ConfigCore {
    ...
    List<String> animalBlacklistRaw = Lists.newArrayList("minecraft:bee");
    ...
    @Config(description = "Make all mobs (not just animals) automatically persistent when spawned using the \"/summon\" command, a spawn egg or a dispenser.")
